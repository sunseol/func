...
// Simple TypeScript syntax validation for workflow components
...
const filesToValidate = [
  'src/components/ai-pm/WorkflowSidebar.tsx',
  'src/components/ai-pm/WorkflowStepNavigation.tsx',
  'src/components/ai-pm/WorkflowGuide.tsx',
  'src/app/ai-pm/[projectId]/workflow/[step]/page.tsx',
  'src/app/ai-pm/[projectId]/page.tsx'
];

console.log('Validating workflow components...\n');
...
console.log(`\n${allValid ? '✓ All workflow components validated successfully' : '✗ Some files have issues'}`);
