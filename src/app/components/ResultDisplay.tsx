...
export default function ResultDisplay({ 
  ...
  return (
    <section
      role="region"
      aria-label="보고서 미리보기"
      className="border rounded-md p-3 sm:p-4 bg-gray-50 dark:bg-neutral-900 dark:border-neutral-800 h-[400px] overflow-y-auto"
    >
      ...
      <pre
        ...
        className="whitespace-pre-wrap break-words font-sans text-sm text-gray-900 dark:text-gray-100"
      >
        {textToDisplay}
      </pre>
    </section>
